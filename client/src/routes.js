...
import { AddEstateContainer, EstatesContainer } from './containers';
  ...
  <Provider store={store}>
    <div className="wrapper">
      <Router history={history}>
        ...
        <Route path="/estates" component={Archive}>
          <IndexRoute component={EstatesContainer} />
          <Route path="add" component={requireAuthentication(AddEstateContainer)} />
        </Route>
